...
<div class="documentation">
    ...
    <ol>
        ...
        <li>When the bot has joined your server, do the following setup commands</strong>
            <ol>
                <li><strong>/admin set apikey (your-api-key)</strong> to set your Pl@ntNet API key</li>
                <li><strong>/admin set recchan (channel name)</strong> to set the plant recognition channel</li>
            </ol>
        </li>

        <li>You can run the following general commands</strong>
            <ol>
                <li><strong>/admin stats</strong> to see the current bot statistics for your server</li>
                <li><strong>/info</strong> can be used by anyone to print general information about the bot</li>
            </ol>
        </li>
